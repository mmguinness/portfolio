...
1.  **Everything takes longer than expected**, leave lots of time to explore unexpected things you encouter along the way, such as [pagination](https://en.wikipedia.org/wiki/Pagination).
...
Homepage - current & previously selected books:
<figure>
